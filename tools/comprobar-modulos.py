...
RAIZ = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "vatia", "app", "static")
...
def main():
    ...
    if fallos:
        ...
        return 1
    print(f"{len(files)} módulos · imports correctos · sin exports huérfanos · sin ciclos")
    for f in files:
